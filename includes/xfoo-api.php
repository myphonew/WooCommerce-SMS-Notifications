...
/**
 *  xfoo.net API Integration Functions (Modified)
 */
...
{
    $url = XFOO_SERVER . "/services/send.php";
    $postData = array(
        'number' => $number,
        'message' => $message,
        'schedule' => $schedule,
 ...
 */
function sendMessages($messages, $option = XFOO_USE_SPECIFIED, $devices = [], $schedule = null, $useRandomDevice = false)
{
    $url = XFOO_SERVER . "/services/send.php";
    $postData = [
 ...
 * @throws Exception If there is an error while sending messages.
 */
function sendMessageToContactsList($listID, $message, $option = XFOO_USE_SPECIFIED, $devices = [], $schedule = null, $isMMS = false, $attachments = null)
{
    $url = XFOO_SERVER . "/services/send.php";
    $postData = [
        'listID' => $listID,
...
{
    $url = XFOO_SERVER . "/services/read-messages.php";
    $postData = [
        'key' => XFOO_API_KEY,
        'id' => $id
    ];
...
{
    $url = XFOO_SERVER . "/services/resend.php";
    $postData = [
        'key' => XFOO_API_KEY,
        'id' => $id
    ];
...
{
    $url = XFOO_SERVER . "/services/manage-contacts.php";
    $postData = [
        'key' => XFOO_API_KEY,
        'listID' => $listID,
        'number' => $number,
...
{
    $url = XFOO_SERVER . "/services/send-ussd-request.php";
    $postData = [
        'key' => XFOO_API_KEY,
        'request' => $request,
        'device' => $device,
...
{
    $url = XFOO_SERVER . "/services/read-ussd-requests.php";
    $postData = [
        'key' => XFOO_API_KEY,
        'id' => $id
    ];
 ...
 */
function getDevices() {
    $url = XFOO_SERVER . "/services/get-devices.php";
    $postData = [
        'key' => XFOO_API_KEY
    ];
